/**
 * Chart from https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/combo-meteogram/
 * Changed for own needs
 */

import { getWeatherSymbolImage } from "../utils/weatherSymbolsUtils";

var Highcharts = require('highcharts/highstock');
window.Highcharts = Highcharts;
require('highcharts/modules/windbarb')(Highcharts);

export function Meteogram(xml, container) {
...
Meteogram.prototype.drawWeatherSymbols = function (chart) {
    ...
    chart.series[0].data.forEach(function (point) {
        if (meteogram.resolution > 36e5 || i % 2 === 0) {
            chart.renderer
                .image(
                    getWeatherSymbolImage(meteogram.symbols[i]),
...
Meteogram.prototype.error = function () {
    document.getElementById(this.container).innerHTML = '<i class="fa fa-frown-o"></i> Failed loading data, please try again later';
};
